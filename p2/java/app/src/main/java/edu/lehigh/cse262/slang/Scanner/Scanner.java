...
public class Scanner {
     ...
     * Then we make a transistion to the corresponding state from START state and not allowed to go back to START
     ...
     * In the CLEANBREAK, if the Error flag is still raised, we will reset every state to false to only output the Error message
